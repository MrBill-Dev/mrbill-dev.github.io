...
var BLOG_AUTHOR = {
  ...
  intro: [
    "從學生時代開始接觸網站企劃與製作，累積約 20 年網站相關經驗；現任高點知識達教育出版集團網站企劃，實務涵蓋網站企劃、前端維護、JavaScript／Vue 功能開發，以及與後端系統串接協作。",
    "本站是我個人經營的數位實驗室，整理前端、SEO/GEO、AI 工作流、自動化、Agent、設計與影像創作等實作經驗，把做過、測過、踩過坑的方法，轉成學生、上班族、家長與創作者都能理解、也能實際應用的數位筆記。"
  ],
  moreLabel: "更多背景與專長",
  details: [
    {
      ...
      text:
        "機械製圖與纖維科技的背景，讓我習慣從結構、比例、材料與流程角度拆解問題，也影響後來在網站、設計與影像工作上的判斷方式。"
    },
    {
      label: "前端與網站",
      items: [
        ...
        "十多年正式網頁前端、網站維護與企劃實務",
        "熟悉 RWD、UI 介面、互動元件與活動頁製作",
        "具備 JavaScript、jQuery、Vue 前端實作經驗",
        "接觸 ASP、ASP.NET、PHP 等網站環境整合"
      ],
      text:
        "我重視的不只是網站好不好看，而是能不能被看懂、被操作、被搜尋，並真正協助內容或服務被使用者找到。"
    },
    {
      label: "SEO / GEO 實務",
      items: [
      ...
      text:
        "對我來說，SEO/GEO 不是只改 meta，而是一套從內容、結構、技術到驗證的持續調整流程。"
    },
    {
      ...
      text:
        "AI 對我來說不是取代專業，而是把企劃、設計、前端、內容與維護流程重新拆解，進一步加速、驗證與自動化。"
    },
    {
      label: "設計、工程與視覺判斷",
      items: [
      ...
      text:
        "這些跨域背景讓我在處理網站、設計與 AI 工具時，更習慣用「拆解、整合、驗證」的方式完成作品。"
    },
    {
      label: "影像創作與生活拍攝",
      items: [
        "曾以婚禮攝影作為專業副業，長期處理真實拍攝現場",
        "熟悉光線判斷、構圖、人物情緒與關鍵畫面捕捉",
        "參與過微電影拍攝與影像製作，熟悉畫面敘事與節奏安排",
        "具備影片剪輯、後期調色與影像敘事經驗",
        "現在更偏向記錄生活、孩子成長與日常動態影像",
        "將攝影經驗延伸到網站 UI、內容編排與品牌形象"
      ],
      text:
        "過去的婚禮攝影訓練了我對光線、節奏與瞬間情緒的判斷；現在則更常把這份熱情放進生活與孩子的動態紀錄裡。這些影像經驗，也讓我在做網站與內容時，更重視畫面感、閱讀節奏與情緒連結。"
    },
    {
      label: "現階段",
      items: [
