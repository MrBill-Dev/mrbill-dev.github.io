...
(function (global) {
  ...
  function renderSpots(filter) {
    ...
    spots.forEach(function (spot, index) {
      ...
      card.innerHTML =
        ...
        spot.summary +
        '</p><div class="rainy-tags"><button type="button" class="rainy-tag rainy-tag--map" data-rainy-map="' +
        spot.title +
        '">📍 ' +
        spot.area +
  ...
  function openModal(index) {
    ...
    document.getElementById("rainyModalBody").innerHTML =
      ...
      "<h4>家長提醒</h4><p>" +
      spot.tips +
      '</p><p class="rainy-modal-note">以上開放時間與費用為整理參考，臨時休館、場次異動與票價調整請以官方公告為準。</p><div class="rainy-modal-actions">' +
      '<a class="dark" href="' +
      spot.official +
