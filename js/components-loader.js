...
function initBlogNavNewIndicator() {
    ...
    loadSiteScriptOnce('blog-articles.js?v=rail-flat-links-1')
        .then(function () {
            if (typeof syncBlogNavNewIndicator === 'function') {
                syncBlogNavNewIndicator();
            }
...
function injectSiteRwdStyles() {
    ...
    style.textContent = [
        ...
        ':root { --site-fab-bottom: 1.25rem; --site-fab-size: 3.25rem; --site-fab-gap: 0.625rem; }',
        '@media (max-width: 639px) { :root { --site-fab-bottom: 1rem; --site-fab-size: 3rem; } }',
        '@media (max-width: 1023px) { body.has-mobile-dock.is-mobile-dock-visible { --site-fab-bottom: 5.75rem; } }',
        'body.has-ai-update-fab #ai-update-fab { position: fixed; right: 1rem; bottom: calc(var(--site-fab-bottom) + var(--site-fab-size) + var(--site-fab-gap)); z-index: 44; }',
        '@media (max-width: 639px) { body.has-ai-update-fab #ai-update-fab { right: 0.875rem; } }',
