...
function buildStaticSeoHead(article, pageUrl) {
  ...
  const ogImageAlt = String(article.title || SITE_NAME).trim();
...
export function buildPublishedArticlePageHtml(article) {
  ...
  return (
    ...
    '  <script src="../../js/blog-articles.js?v=dynamic-loading-fix-1"></script>\n' +
    ...
    '  <script src="../../js/notebooklm-guide-tools.js?v=nlm-readability-2"></script>\n' +
    quizAssets +
    BLOG_SERIF_FONT_HEAD +
    '  <link rel="stylesheet" href="../../css/blog-layout.css?v=nlm-readability-2" />\n' +
    "  <style>\n" +
    ...
    "      display: none;\n" +
    "    }\n" +
    "    .blog-preview-banner.is-visible { display: block; }\n" +
    "    #blog-dynamic-loading { display: none; }\n" +
    '    html[data-blog-dynamic-loading="1"] #blog-dynamic-loading { display: block; }\n' +
    "  </style>\n" +
    "</head>\n" +
    ...
    '  <div id="blog-preview-banner" class="blog-preview-banner" role="status"></div>\n' +
