...
export function buildPublishedArticlePageHtml(article) {
  ...
  return (
    ...
    '  <script src="../../js/blog-articles.js?v=author-profile-11"></script>\n' +
    '  <script src="../../js/blog-stats.config.js?v=20260608"></script>\n' +
    '  <script src="../../js/blog-stats.js?v=clean-slug-url-1"></script>\n' +
    '  <script src="../../js/blog-article-ui.js?v=author-profile-11"></script>\n' +
    quizAssets +
    BLOG_SERIF_FONT_HEAD +
    '  <link rel="stylesheet" href="../../css/blog-layout.css?v=author-profile-11" />\n' +
    "  <style>\n" +
